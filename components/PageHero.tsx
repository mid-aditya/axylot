    ...
    <section className="relative pt-48 pb-24 overflow-hidden border-b border-white/5">
      ...
      <div className="grid-container">
        <motion.div
          ...
          className="max-w-5xl"
        >
          <motion.div variants={itemVars} className="flex items-center gap-3 mb-10">
          ...
          <h1 className="text-[8vw] sm:text-[6vw] leading-[0.9] font-bold tracking-tight uppercase mb-12">
          ...
          <motion.div variants={itemVars}>
            <p className="text-xl md:text-2xl leading-relaxed opacity-40 font-light max-w-2xl">
              {subtitle}
            </p>
          </motion.div>
        </motion.div>
